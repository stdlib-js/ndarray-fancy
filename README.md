...
```javascript
FancyArray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-fancy@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-fancy@v0.2.2-umd/browser.js"></script>
```
